...
feature_cards:
  - title: "Obserwacje"
    content: "Od lat **aktywnie obserwujemy rozwój Digital Delivery i towarzyszących mu rozwiązań technologicznych**. Widzieliśmy, jak pracownie i firmy, w których pracowaliśmy, kupowały pierwsze licencje na \"oprogramowanie do BIM-u\", mianowały pierwszego BIM managera i podejmowały pierwsze batalie z ustandaryzowaniem pracy na nowych zasadach. \n\n Nie byliśmy biernymi widzami — byliśmy w samym środku: projektowaliśmy, koordynowaliśmy, standaryzowaliśmy, modelowaliśmy i zarządzaliśmy danymi. Tworzyliśmy pierwsze automatyzacje, skrypty w Dynamo, zasady pracy w tym czy innym narzędzu i wymyślaliśmy triki łamiące ograniczenia nałożone przez twórców oprogramowania. Z czasem **staliśmy się 'tymi, którzy wiedzą'** – osobami, do których inni przychodzą w poszukiwaniu odpowiedzi."
    icon: |
  ...
  - title: "Doświadczenie"
    content: "Zawsze **byliśmy i jesteśmy tam, gdzie BIM się DZIEJE – nie tylko w teoriach i dyskusjach, ale w codziennych wyzwaniach projektowych**. \n\n  W naszym \"szamańskim\" projekcie dzielimy się przemyśleniami, magicznymi sztuczkami i automatyzacjami. Nie będziemy mówić, jaki BIM powinien być – pokażemy, jaki jest i co można z niego wycisnąć tu i teraz."
    icon: |
      <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  - title: "Eksperymenty"
    content: "Wielokrotnie **widzieliśmy, jak \"jedyne słuszne\" i \"idealne\" rozwiązania rozbijały się w zderzeniu z realnymi wyzwaniami - codziennością projektantów, inżynierów i klientów** i z tego powodu nie zamierzamy nikogo przekonywać, że nasze podejście jest właściwe, rewolucyjne czy też najlepsze na świecie. Wiemy jednak, że działa – bo testowaliśmy je na froncie, tam, gdzie \"słuszne\" plany często przegrywają z rzeczywistością budownictwa. \n\n  Eksperymentowanie to w BIM-ie codzienność, a my nie boimy się przemyśleć podejścia na nowo. Pozwolimy sobie również trochę ponarzekać oraz pożartować, ponieważ chcemy pokazać, że lubimy to, co robimy – rozwiązywać wyzwania stawiane na naszej ścieżce w cyfrowym świecie, pamiętając jak niecyfrowe jest finalne dzieło."
    icon: |
      <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  - title: "Rozwiązania"
    content: "**Zgromadziło nas podejście stawiające efekt na pierwszym miejscu, z pominięciem otoczki marketingu, inżyniersko do celu.** Gdy kapłani tego czy innego narzędzia, formatu wymiany danych lub normy głosili ich wyższość nad innymi rozwiązaniami, my z szamańską zawziętością zajmowaliśmy się kończeniem kolejnego projektu. Narzędzie pozostanie tylko narzędziem do momentu, gdy zostanie odpowiednio użyte i odrobina sceptycyzmu w stosunku do obietnicy jakie niosą jego funkcje zawsze jest zaleca. \n\n  Na koniec dnia, ważniejsze niż bycie ekspertem od czarnej czy białej magii, jest bycie ekspertem od dostarczenia rozwiązania."
    icon: |
      <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  - title: "Rzeczywistość"
    content: "Oto, jesteśmy...\n<div class=\"feature-card__image-pair\"><img src=\"/images/images-main/Image_About_BIMSpecialist-A.jpg\" alt=\"BIM Specialist\"><img src=\"/images/images-main/Image_About_BIMSpecialist-B.jpg\" alt=\"in a nutshell\"></div>"
    icon: |
      <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
authors:
  ...
  - name: "Natalia Gawlik"
    ...
    role: "BIM Manager Infrastruktura & Specjalista VDC"
    ...
    feature_cards:
      ...
      - title: "Koordynator BIM i Workflow - Infrastruktura"
