...
<div class="portfolio-collection__container">
  ...
  <div class="blog__controls portfolio__controls">
...
document.addEventListener('DOMContentLoaded', function () {
  var list = document.querySelector('.portfolio-collection__list');
  if (!list) return;
  ...
  function applySearchFilter(query) {
    ...
    var empty = tilesContainer.querySelector('.portfolio-collection__empty');
    if (visible === 0) {
      if (!empty) {
        var e = document.createElement('div');
        e.className = 'portfolio-collection__empty';
