...
feature_cards:
  ...
  - title: "Solutions"
    content: "**What brought us together was a results-driven mindset—one that skips the marketing fluff and takes a straight engineering route to the goal.** While the high priests of this or that tool, data exchange format, or standard preached their superiority, we - like stubborn shaman, were busy finishing yet another project. In the end of the day, more important than being dark or light magic expert, is being expert in problem solving."
    icon: |
      <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
